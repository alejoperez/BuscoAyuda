# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-07 00:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imageFile', models.ImageField(null=True, upload_to='polls/templates/polls/images')),
        ...
        migrations.AddField(
            ...
            name='job',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='polls.Job', unique=True),
        ),
        migrations.AddField(
            model_name='independent',
            name='user',
